...
class Cornac_Auditeur_Analyzer_Classes_Statics extends Cornac_Auditeur_AnalyzerAttributes {
	...
	public function analyse() {
        ...
        $this->backend->type(array('method_static','property_static','constant_static'));
