...
class MethodSignatureMustBeCompatible extends Analyzer {
    ...
    public function testClasses_MethodSignatureMustBeCompatible06()  { $this->generic_test('Classes/MethodSignatureMustBeCompatible.06'); }
    public function testClasses_MethodSignatureMustBeCompatible07()  { $this->generic_test('Classes/MethodSignatureMustBeCompatible.07'); }
}
?>