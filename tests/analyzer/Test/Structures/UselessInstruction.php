...
class UselessInstruction extends Analyzer {
    ...
    public function testStructures_UselessInstruction18()  { $this->generic_test('Structures/UselessInstruction.18'); }
    public function testStructures_UselessInstruction19()  { $this->generic_test('Structures/UselessInstruction.19'); }
    public function testStructures_UselessInstruction20()  { $this->generic_test('Structures/UselessInstruction.20'); }
    public function testStructures_UselessInstruction21()  { $this->generic_test('Structures/UselessInstruction.21'); }
    ...
    public function testStructures_UselessInstruction26()  { $this->generic_test('Structures/UselessInstruction.26'); }
    public function testStructures_UselessInstruction27()  { $this->generic_test('Structures/UselessInstruction.27'); }
    public function testStructures_UselessInstruction28()  { $this->generic_test('Structures/UselessInstruction.28'); }
    public function testStructures_UselessInstruction29()  { $this->generic_test('Structures/UselessInstruction.29'); }
}
?>