...
class Structures_StrposCompare extends Analyzer {
    ...
    public function testStructures_StrposCompare09()  { $this->generic_test('Structures/StrposCompare.09'); }
    public function testStructures_StrposCompare10()  { $this->generic_test('Structures/StrposCompare.10'); }
}
?>