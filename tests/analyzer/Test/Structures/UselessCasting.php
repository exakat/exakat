...
class UselessCasting extends Analyzer {
    ...
    public function testStructures_UselessCasting05()  { $this->generic_test('Structures/UselessCasting.05'); }
    public function testStructures_UselessCasting06()  { $this->generic_test('Structures/UselessCasting.06'); }
}
?>