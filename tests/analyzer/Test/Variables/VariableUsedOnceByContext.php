...
class VariableUsedOnceByContext extends Analyzer {
    ...
    public function testVariables_VariableUsedOnceByContext15()  { $this->generic_test('Variables/VariableUsedOnceByContext.15'); }
    public function testVariables_VariableUsedOnceByContext16()  { $this->generic_test('Variables/VariableUsedOnceByContext.16'); }
    public function testVariables_VariableUsedOnceByContext17()  { $this->generic_test('Variables/VariableUsedOnceByContext.17'); }
}
?>