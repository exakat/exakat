...
class a {
    public    const APUBLICBUTSBPRIVATE = 1, APUBLICBUTSBPRIVATE2 = 2, APUBLICBUTREALLY2 = 3, APUBLICBUTREALLY3 = 6, APUBLICBUTREALLY4 = 7;
...
A::APUBLICBUTREALLY2;
D::APUBLICBUTSBPRIVATE2; // Some other class
