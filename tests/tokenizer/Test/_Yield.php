...
class _Yield extends Tokenizer {
    ...
    public function test_Yield11()  { $this->generic_test('_Yield.11'); }
    public function test_Yield12()  { $this->generic_test('_Yield.12'); }
    public function test_Yield13()  { $this->generic_test('_Yield.13'); }
}
?>