...
class Multiplication extends Tokenizer {
    /* 36 methods */
    ...
    public function testMultiplication21()  { $this->generic_test('Multiplication.21'); }
    public function testMultiplication22()  { $this->generic_test('Multiplication.22'); }
    public function testMultiplication23()  { $this->generic_test('Multiplication.23'); }
    public function testMultiplication24()  { $this->generic_test('Multiplication.24'); }
    public function testMultiplication25()  { $this->generic_test('Multiplication.25'); }
    public function testMultiplication26()  { $this->generic_test('Multiplication.26'); }
    public function testMultiplication27()  { $this->generic_test('Multiplication.27'); }
    public function testMultiplication28()  { $this->generic_test('Multiplication.28'); }
    public function testMultiplication29()  { $this->generic_test('Multiplication.29'); }
    public function testMultiplication30()  { $this->generic_test('Multiplication.30'); }
    public function testMultiplication31()  { $this->generic_test('Multiplication.31'); }
    public function testMultiplication32()  { $this->generic_test('Multiplication.32'); }
    public function testMultiplication33()  { $this->generic_test('Multiplication.33'); }
    public function testMultiplication34()  { $this->generic_test('Multiplication.34'); }
    public function testMultiplication35()  { $this->generic_test('Multiplication.35'); }
    public function testMultiplication36()  { $this->generic_test('Multiplication.36'); }
}
?>