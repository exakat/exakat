...
class Concatenation extends Tokenizer {
    ...
    public function testConcatenation36()  { $this->generic_test('Concatenation.36'); }
    public function testConcatenation37()  { $this->generic_test('Concatenation.37'); }
    public function testConcatenation38()  { $this->generic_test('Concatenation.38'); }
    public function testConcatenation39()  { $this->generic_test('Concatenation.39'); }
    public function testConcatenation40()  { $this->generic_test('Concatenation.40'); }
    public function testConcatenation41()  { $this->generic_test('Concatenation.41'); }
    public function testConcatenation42()  { $this->generic_test('Concatenation.42'); }
    public function testConcatenation43()  { $this->generic_test('Concatenation.43'); }
    public function testConcatenation44()  { $this->generic_test('Concatenation.44'); }
    public function testConcatenation45()  { $this->generic_test('Concatenation.45'); }
    public function testConcatenation46()  { $this->generic_test('Concatenation.46'); }
    public function testConcatenation47()  { $this->generic_test('Concatenation.47'); }
    public function testConcatenation48()  { $this->generic_test('Concatenation.48'); }
    public function testConcatenation49()  { $this->generic_test('Concatenation.49'); }
    public function testConcatenation50()  { $this->generic_test('Concatenation.50'); }
    public function testConcatenation51()  { $this->generic_test('Concatenation.51'); }
    public function testConcatenation52()  { $this->generic_test('Concatenation.52'); }
    public function testConcatenation53()  { $this->generic_test('Concatenation.53'); }
    public function testConcatenation54()  { $this->generic_test('Concatenation.54'); }
    public function testConcatenation55()  { $this->generic_test('Concatenation.55'); }
    public function testConcatenation56()  { $this->generic_test('Concatenation.56'); }
    public function testConcatenation57()  { $this->generic_test('Concatenation.57'); }
    public function testConcatenation58()  { $this->generic_test('Concatenation.58'); }
    public function testConcatenation59()  { $this->generic_test('Concatenation.59'); }
    public function testConcatenation60()  { $this->generic_test('Concatenation.60'); }
    public function testConcatenation61()  { $this->generic_test('Concatenation.61'); }
    ...
    public function testConcatenation66()  { $this->generic_test('Concatenation.66'); }
    public function testConcatenation67()  { $this->generic_test('Concatenation.67'); }
    public function testConcatenation68()  { $this->generic_test('Concatenation.68'); }
    public function testConcatenation69()  { $this->generic_test('Concatenation.69'); }
    public function testConcatenation70()  { $this->generic_test('Concatenation.70'); }
}
?>