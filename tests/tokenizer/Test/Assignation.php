...
class Assignation extends Tokenizer {
    ...
    public function testAssignation24()  { $this->generic_test('Assignation.24'); }
    public function testAssignation25()  { $this->generic_test('Assignation.25'); }
    public function testAssignation26()  { $this->generic_test('Assignation.26'); }
    public function testAssignation27()  { $this->generic_test('Assignation.27'); }
    public function testAssignation28()  { $this->generic_test('Assignation.28'); }
    public function testAssignation29()  { $this->generic_test('Assignation.29'); }
    public function testAssignation30()  { $this->generic_test('Assignation.30'); }
    public function testAssignation31()  { $this->generic_test('Assignation.31'); }
    public function testAssignation32()  { $this->generic_test('Assignation.32'); }
    public function testAssignation33()  { $this->generic_test('Assignation.33'); }
    public function testAssignation34()  { $this->generic_test('Assignation.34'); }
    public function testAssignation35()  { $this->generic_test('Assignation.35'); }
}
?>