...
class _New extends Tokenizer {
    ...
    public function test_New19()  { $this->generic_test('_New.19'); }
    public function test_New20()  { $this->generic_test('_New.20'); }
    public function test_New21()  { $this->generic_test('_New.21'); }
    public function test_New22()  { $this->generic_test('_New.22'); }
    public function test_New23()  { $this->generic_test('_New.23'); }
    public function test_New24()  { $this->generic_test('_New.24'); }
    public function test_New25()  { $this->generic_test('_New.25'); }
    public function test_New26()  { $this->generic_test('_New.26'); }
    public function test_New28()  { $this->generic_test('_New.28'); }
    public function test_New29()  { $this->generic_test('_New.29'); }
}
?>