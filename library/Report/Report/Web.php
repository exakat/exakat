...
class Web {
    ...
    public function prepare() {
        $noResults = new \Report\Content\NoResult();
...
//            $analyzer->setBunch($analyzes);
        ...
        $this->createH2('No results');
        $this->addContent('Text', 'The following analyzers were run. They yielded no result.');
        $this->addContent('Liste', $noResults);
