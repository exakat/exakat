...
/////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->createLevel2('Spip report');
        $analyzer = $this->getContent('Dashboard');
        $analyzer->setThema('Spip');
        $analyzer->collect();
...
/////////////////////////////////////////////////////////////////////////////////////
        ...
        $analyzes = array_merge(\Analyzer\Analyzer::getThemeAnalyzers('Spip'),
                ...
                if ($analyzer->hasResults()) {
                    ...
                    if (get_class($analyzer) == "Analyzer\\Php\\Incompilable") {
                        ...
                        if ($clearPHP = $analyzer->getDescription()->getClearPHP()) {
                            $this->addContent('Text', 'clearPHP : '.$clearPHP."\n", 'textLead');
                        }
