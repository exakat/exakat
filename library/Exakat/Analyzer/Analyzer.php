...
abstract class Analyzer {
    ...
    public const TYPE_ATOMS       = array('Integer', 'String', 'Arrayliteral', 'Float', 'Boolean', 'Null', 'Closure', 'Concatenation', 'Magicconstant', 'Heredoc', 'Power' , "Classconstant", "Comparison", "Not", 'Multiplication', 'Bitshift', 'Bitoperation', 'Logical');
