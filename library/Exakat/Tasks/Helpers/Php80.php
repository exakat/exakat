...
class Php80 extends Php {
    ...
    const T_INC                           = 383;
    const T_DEC                           = 384;
    const T_OBJECT_OPERATOR               = 385;
    const T_NULLSAFE_OBJECT_OPERATOR      = 386;
    const T_COMMENT                       = 387;
    ...
    const T_NS_SEPARATOR                  = 398;
    const T_ELLIPSIS                      = 399;
    const T_BAD_CHARACTER                 = 400;
    const T_DOUBLE_COLON                  = 397;
}
?>
