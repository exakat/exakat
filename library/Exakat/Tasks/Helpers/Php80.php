...
class Php80 extends Php {
    ...
    const T_INC                           = 380;
    const T_DEC                           = 381;
    const T_OBJECT_OPERATOR               = 382;
    const T_COMMENT                       = 383;
    const T_DOC_COMMENT                   = 384;
    const T_OPEN_TAG                      = 385;
    const T_OPEN_TAG_WITH_ECHO            = 386;
    const T_CLOSE_TAG                     = 387;
    const T_WHITESPACE                    = 388;
    const T_START_HEREDOC                 = 389;
    const T_END_HEREDOC                   = 390;
    const T_DOLLAR_OPEN_CURLY_BRACES      = 391;
    const T_CURLY_OPEN                    = 392;
    const T_PAAMAYIM_NEKUDOTAYIM          = 393;
    const T_NS_SEPARATOR                  = 394;
    const T_ELLIPSIS                      = 395;
    const T_BAD_CHARACTER                 = 396;
    const T_DOUBLE_COLON                  = 393;
}
?>
