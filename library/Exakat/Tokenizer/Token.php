...
abstract class Token {
    static public $ATOMS = array('Arguments', 'Array', 'Arrayappend', 'As', 'Block', 'Boolean', 'Break', 'Case', 'Cast', 'Catch', 'Class', 'Clone', 'Concatenation', 'Const', 'Constant', 'Continue', 'Declare', 'Default', 'Dowhile', 'File', 'Finally', 'For', 'Foreach', 'Function', 'Functioncall', 'Goto', 'Halt', 'Heredoc', 'Identifier', 'Ifthen', 'Include', 'Instanceof', 'Interface', 'Label', 'Method', 'Methodcall', 'Namespace', 'New', 'Noscream', 'Not', 'Nsname', 'Null', 'Parenthesis', 'Php', 'Postplusplus', 'Preplusplus', 'Project', 'Property', 'Return', 'Sequence', 'Shell', 'Sign', 'Staticclass', 'Staticconstant', 'Staticmethodcall', 'Staticproperty', 'String', 'Switch', 'Ternary', 'Throw', 'Trait', 'Try', 'Use', 'Variable', 'Void', 'While', 'Yield', 'Yieldfrom');
