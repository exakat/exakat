...
abstract class Token {
    const ATOMS = array('Break', 'Continue', 'Arguments', 'Array', 'Arrayappend', 'Block', 'Boolean', 'Case', 'Catch', 'Class', 'Const', 'Declare', 'Default', 'Dowhile', 'File', 'Finally', 'For', 'Foreach', 'Function', 'Functioncall', 'Heredoc', 'Identifier', 'Ifthen', 'Interface', 'Label', 'Methodcall', 'Namespace', 'Nsname', 'Null', 'Parenthesis', 'Php', 'PostPlusPlus', 'Project', 'Property', 'Return', 'Sequence', 'Shell', 'Sign', 'Staticconstant', 'Staticmethodcall', 'Staticproperty', 'String', 'Switch', 'Ternary', 'Trait', 'Try', 'Use', 'Variable', 'Void', 'While', 'Yield');
