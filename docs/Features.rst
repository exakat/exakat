...
There are currently 386 different analyzers that check the PHP code to report code smells. Analyzers are inspired by PHP manual, migration documents, community good practices, computer science or simple logic. 
...
.. image:: images/dashboard.748.png
    :alt: 386 analysis with faceted search
